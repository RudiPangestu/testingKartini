    ...
    <div class="overflow-x-auto rounded-xl border border-gray-200 bg-white">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50" wire:key="gb-<?php echo e($b->id); ?>">
                        <td class="px-4 py-3 font-medium"><?php echo e($b->schoolClass?->name); ?></td>
                        <td class="px-4 py-3"><?php echo e($b->subject?->name); ?></td>
                        <td class="px-4 py-3 text-gray-500"><?php echo e($b->academic_year); ?></td>
                        <td class="px-4 py-3 text-gray-500"><?php echo e($b->cawu); ?></td>
                        <td class="px-4 py-3 text-gray-500"><?php echo e($b->kkm); ?></td>
                        <td class="px-4 py-3 text-right whitespace-nowrap">
                            <a href="<?php echo e(route('grades.input', $b->id)); ?>" class="mr-2 text-emerald-700 hover:underline">Input Nilai</a>
                            <button wire:click="delete('<?php echo e($b->id); ?>')" wire:confirm="Hapus buku nilai ini beserta semua nilainya?" class="text-red-600 hover:underline">Hapus</button>
                        </td>
                    </tr>
...
<?php /**PATH /Users/rudipangestu/Downloads/claudecode/kartini/testingKartini/laravel/resources/views/livewire/grades/index.blade.php ENDPATH**/ ?>