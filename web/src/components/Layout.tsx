...
const NAV: NavItem[] = [
  ...
  { to: '/daftar-hadir', label: 'Daftar Hadir', roles: ['ADMIN', 'GURU'], icon: <I d="M9 11l3 3L22 4M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11" /> },
  { to: '/nilai', label: 'Daftar Nilai', roles: ['ADMIN', 'GURU'], icon: <I d="M12 20l9-5-9-5-9 5 9 5zM12 12V4M8 6l4-2 4 2" /> },
  ...
  { to: '/pelanggaran', label: 'Pelanggaran', roles: ['ADMIN'], icon: <I d="M12 9v4M12 17h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z" /> },
